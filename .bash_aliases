...
alias cf='/storage/src/devops/shellscripts/utils/backup-current-local-file-clipboard.sh && nvim /tmp/clipboard/copied.txt'
alias cl='ncal -3w -M'
alias gfpl='g f && g pl'
...
alias tm='tmux'
alias tp='tmuxp load $(find /storage/src /kvm/octerra/tmuxp /kvm/labs/tmuxp -type f | grep -v ".git/" | grep "tmuxp/" | sort | fzf)'
alias tl='tmux ls'
...
alias vcb='wl-paste | nvim -'                          # Open clipboard contents on nvim
