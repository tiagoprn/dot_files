...
nnoremap <F10> :SearchQuickNotes<cr>| " (telescope)(function-keys) search quick note
nnoremap <F11> :SearchWriteloop<cr>| " (telescope)(function-keys) search zettelkasten card
