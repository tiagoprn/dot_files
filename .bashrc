...
alias upgrade='sudo reflector --age 8 --fastest 128 --latest 64 --number 32 --sort rate --save /etc/pacman.d/mirrorlist && yaourt -Syyua --color --noconfirm'
...
alias tmux-autostart='pyenv activate utils && /storage/src/devops/tmuxp/start_everything.sh && pyenv deactivate && tmux -2 a -t HOME '
